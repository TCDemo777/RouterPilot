...
RouterPilot v2.0.3 is a focused reliability update for Network Health, firmware status and navigation, optional AdGuard health monitoring, and change-detection logging. The v2.0.2 audited SSH.NET and System.Drawing.Common security maintenance remains included.
...
Release assets are published as `RouterPilot-2.0.3-x64.msi` and `RouterPilot-2.0.3-win-x64.zip`.
