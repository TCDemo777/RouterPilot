...
public partial class RouterProfilesWindow : Window
{
    ...
    public RouterProfilesWindow() { InitializeComponent(); Profiles.ItemsSource = Items; Reload(); }
    ...
    public sealed record Row(RouterProfile Profile, bool IsActive, bool Multiple) { public string DisplayName => Profile.DisplayName; public string RouterHost => Profile.RouterHost; public string ActiveLabel => IsActive ? "Active" : ""; public bool CanSwitch => !IsActive; public bool CanRemove => Multiple && !IsActive; }
}
