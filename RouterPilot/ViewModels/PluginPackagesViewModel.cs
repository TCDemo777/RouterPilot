...
public partial class PluginPackagesViewModel : ObservableObject
{
    ...
    [ObservableProperty] private string searchText = string.Empty; [ObservableProperty] private string selectedFilter = "All"; [ObservableProperty] private PluginPackage? selectedPackage; [ObservableProperty] private bool isLoading; [ObservableProperty] private string statusMessage = "Plug-ins have not been loaded."; [ObservableProperty] private string indexStatus = "Unknown"; [ObservableProperty] private int installedCount; [ObservableProperty] private int availableCount; [ObservableProperty] private string updatesCount = "—";
