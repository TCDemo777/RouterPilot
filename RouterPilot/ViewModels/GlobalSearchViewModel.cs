...
namespace RouterPilot.ViewModels
{
    public partial class GlobalSearchViewModel : ObservableObject
    {
        ...
        private static readonly (string Title, string Subtitle, string Terms, string Target)[] Pages = [("Overview", "Page", "overview home dashboard", "overview"), ("Clients", "Page", "clients devices", "clients"), ("Router", "Router page", "router telemetry overview ports wifi multi-wan dns performance", "router"), ("Wi-Fi", "Network page", "wifi wi-fi wireless", "wifi"), ("Port Forwarding", "Network page", "port forwarding port forward nat", "port-forward"), ("DHCP", "Network page", "dhcp reservations leases", "dhcp"), ("VPN", "Network page", "vpn", "vpn"), ("DNS Filtering", "Page", "dns adguard protection", "protection"), ("Timeline", "Page", "timeline logs history", "timeline"), ("System Health", "Page", "health system health", "health"), ("Analytics", "Page", "analytics diagnostics", "analytics"), ("Settings", "Page", "settings", "settings")];
